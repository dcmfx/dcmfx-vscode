    ...
    if ((bytes.bitSize - 8) % 8 === 0) {
      ...
      if (byte_0 <= 0x7F) {
        ...
        if (bytes.bitSize >= 16) {
          if ((bytes.bitSize - 16) % 8 === 0) {
            ...
            if ((((byte_0$1 >= 0xC0) && (byte_0$1 <= 0xDF)) && (byte_1 >= 0x80)) && (byte_1 <= 0xBF)) {
              ...
              if (bytes.bitSize >= 24) {
                if ((bytes.bitSize - 24) % 8 === 0) {
                  ...
                  if ((((((byte_0$2 >= 0xE0) && (byte_0$2 <= 0xEF)) && (byte_1$1 >= 0x80)) && (byte_1$1 <= 0xBF)) && (byte_2 >= 0x80)) && (byte_2 <= 0xBF)) {
                    ...
                    if (bytes.bitSize >= 32) {
                      if ((bytes.bitSize - 32) % 8 === 0) {
                        let byte_0$3 = bytes.byteAt(0);
                        let byte_1$2 = bytes.byteAt(1);
                        let byte_2$1 = bytes.byteAt(2);
                        let byte_3 = bytes.byteAt(3);
                        if ((((((((byte_0$3 >= 0xF0) && (byte_0$3 <= 0xF7)) && (byte_1$2 >= 0x80)) && (byte_1$2 <= 0xBF)) && (byte_2$1 >= 0x80)) && (byte_2$1 <= 0xBF)) && (byte_3 >= 0x80)) && (byte_3 <= 0xBF)) {
                          let rest = bitArraySlice(bytes, 32);
                          let codepoint_value = (($int.bitwise_and(
                            byte_0$3,
                            0x7,
                          ) * 262_144 + $int.bitwise_and(byte_1$2, 0x3F) * 4096) + $int.bitwise_and(
                            byte_2$1,
                            0x3F,
                          ) * 64) + $int.bitwise_and(byte_3, 0x3F);
                          return new Ok(
                            [$utils.int_to_codepoint(codepoint_value), rest],
                          );
                        } else {
                  ...
                  if ((bytes.bitSize - 32) % 8 === 0) {
                    ...
                    let byte_2 = bytes.byteAt(2);
                    let byte_3 = bytes.byteAt(3);
                    if ((((((((byte_0$2 >= 0xF0) && (byte_0$2 <= 0xF7)) && (byte_1$1 >= 0x80)) && (byte_1$1 <= 0xBF)) && (byte_2 >= 0x80)) && (byte_2 <= 0xBF)) && (byte_3 >= 0x80)) && (byte_3 <= 0xBF)) {
                      let rest = bitArraySlice(bytes, 32);
            ...
            if ((bytes.bitSize - 24) % 8 === 0) {
              ...
              let byte_1 = bytes.byteAt(1);
              let byte_2 = bytes.byteAt(2);
              if ((((((byte_0$1 >= 0xE0) && (byte_0$1 <= 0xEF)) && (byte_1 >= 0x80)) && (byte_1 <= 0xBF)) && (byte_2 >= 0x80)) && (byte_2 <= 0xBF)) {
                let rest = bitArraySlice(bytes, 24);
                ...
                if (bytes.bitSize >= 32) {
                  if ((bytes.bitSize - 32) % 8 === 0) {
                    ...
                    let byte_2$1 = bytes.byteAt(2);
                    let byte_3 = bytes.byteAt(3);
                    if ((((((((byte_0$2 >= 0xF0) && (byte_0$2 <= 0xF7)) && (byte_1$1 >= 0x80)) && (byte_1$1 <= 0xBF)) && (byte_2$1 >= 0x80)) && (byte_2$1 <= 0xBF)) && (byte_3 >= 0x80)) && (byte_3 <= 0xBF)) {
                      let rest = bitArraySlice(bytes, 32);
                      let codepoint_value = (($int.bitwise_and(byte_0$2, 0x7) * 262_144 + $int.bitwise_and(
                        byte_1$1,
                        0x3F,
              ...
              if ((bytes.bitSize - 32) % 8 === 0) {
                ...
                let byte_2 = bytes.byteAt(2);
                let byte_3 = bytes.byteAt(3);
                if ((((((((byte_0$1 >= 0xF0) && (byte_0$1 <= 0xF7)) && (byte_1 >= 0x80)) && (byte_1 <= 0xBF)) && (byte_2 >= 0x80)) && (byte_2 <= 0xBF)) && (byte_3 >= 0x80)) && (byte_3 <= 0xBF)) {
                  let rest = bitArraySlice(bytes, 32);
      ...
      if ((bytes.bitSize - 16) % 8 === 0) {
        ...
        if ((((byte_0 >= 0xC0) && (byte_0 <= 0xDF)) && (byte_1 >= 0x80)) && (byte_1 <= 0xBF)) {
          ...
          if (bytes.bitSize >= 24) {
            if ((bytes.bitSize - 24) % 8 === 0) {
              ...
              let byte_1$1 = bytes.byteAt(1);
              let byte_2 = bytes.byteAt(2);
              if ((((((byte_0$1 >= 0xE0) && (byte_0$1 <= 0xEF)) && (byte_1$1 >= 0x80)) && (byte_1$1 <= 0xBF)) && (byte_2 >= 0x80)) && (byte_2 <= 0xBF)) {
                let rest = bitArraySlice(bytes, 24);
                let codepoint_value = ($int.bitwise_and(byte_0$1, 0xF) * 4096 + $int.bitwise_and(
                  byte_1$1,
                  0x3F,
                ...
                if (bytes.bitSize >= 32) {
                  if ((bytes.bitSize - 32) % 8 === 0) {
                    ...
                    let byte_2$1 = bytes.byteAt(2);
                    let byte_3 = bytes.byteAt(3);
                    if ((((((((byte_0$2 >= 0xF0) && (byte_0$2 <= 0xF7)) && (byte_1$2 >= 0x80)) && (byte_1$2 <= 0xBF)) && (byte_2$1 >= 0x80)) && (byte_2$1 <= 0xBF)) && (byte_3 >= 0x80)) && (byte_3 <= 0xBF)) {
                      let rest = bitArraySlice(bytes, 32);
                      let codepoint_value = (($int.bitwise_and(byte_0$2, 0x7) * 262_144 + $int.bitwise_and(
                        byte_1$2,
                        0x3F,
              ...
              if ((bytes.bitSize - 32) % 8 === 0) {
                ...
                let byte_2 = bytes.byteAt(2);
                let byte_3 = bytes.byteAt(3);
                if ((((((((byte_0$1 >= 0xF0) && (byte_0$1 <= 0xF7)) && (byte_1$1 >= 0x80)) && (byte_1$1 <= 0xBF)) && (byte_2 >= 0x80)) && (byte_2 <= 0xBF)) && (byte_3 >= 0x80)) && (byte_3 <= 0xBF)) {
                  let rest = bitArraySlice(bytes, 32);
                  let codepoint_value = (($int.bitwise_and(byte_0$1, 0x7) * 262_144 + $int.bitwise_and(
                    byte_1$1,
                    0x3F,
        ...
        if ((bytes.bitSize - 24) % 8 === 0) {
          ...
          let byte_1 = bytes.byteAt(1);
          let byte_2 = bytes.byteAt(2);
          if ((((((byte_0 >= 0xE0) && (byte_0 <= 0xEF)) && (byte_1 >= 0x80)) && (byte_1 <= 0xBF)) && (byte_2 >= 0x80)) && (byte_2 <= 0xBF)) {
            let rest = bitArraySlice(bytes, 24);
            ...
            if (bytes.bitSize >= 32) {
              if ((bytes.bitSize - 32) % 8 === 0) {
                ...
                let byte_2$1 = bytes.byteAt(2);
                let byte_3 = bytes.byteAt(3);
                if ((((((((byte_0$1 >= 0xF0) && (byte_0$1 <= 0xF7)) && (byte_1$1 >= 0x80)) && (byte_1$1 <= 0xBF)) && (byte_2$1 >= 0x80)) && (byte_2$1 <= 0xBF)) && (byte_3 >= 0x80)) && (byte_3 <= 0xBF)) {
                  let rest = bitArraySlice(bytes, 32);
                  let codepoint_value = (($int.bitwise_and(byte_0$1, 0x7) * 262_144 + $int.bitwise_and(
                    byte_1$1,
                    0x3F,
          ...
          if ((bytes.bitSize - 32) % 8 === 0) {
            ...
            let byte_2 = bytes.byteAt(2);
            let byte_3 = bytes.byteAt(3);
            if ((((((((byte_0 >= 0xF0) && (byte_0 <= 0xF7)) && (byte_1 >= 0x80)) && (byte_1 <= 0xBF)) && (byte_2 >= 0x80)) && (byte_2 <= 0xBF)) && (byte_3 >= 0x80)) && (byte_3 <= 0xBF)) {
              let rest = bitArraySlice(bytes, 32);
