...
export function file_extension_for_transfer_syntax(ts) {
  let ts$1 = ts;
  if (
    (((isEqual(ts$1, $transfer_syntax.jpeg_baseline_8bit)) || (isEqual(
      ts$1,
    ...
    let ts$2 = ts;
    if (
      (isEqual(ts$2, $transfer_syntax.jpeg_ls_lossless)) || (isEqual(
        ts$2,
      ...
      let ts$3 = ts;
      if (
        (((isEqual(ts$3, $transfer_syntax.jpeg_2000_lossless_only)) || (isEqual(
          ts$3,
          $transfer_syntax.jpeg_2000
        ))) || (isEqual(
          ts$3,
          $transfer_syntax.jpeg_2000_multi_component_lossless_only
        ))) || (isEqual(ts$3, $transfer_syntax.jpeg_2000_multi_component))
      ) {
        return ".j2k";
      } else {
        let ts$4 = ts;
        if (
          (((isEqual(ts$4, $transfer_syntax.mpeg2_main_profile_main_level)) || (isEqual(
            ts$4,
          ...
          let ts$5 = ts;
          if (
            (((((((((isEqual(ts$5, $transfer_syntax.mpeg4_avc_h264_high_profile)) || (isEqual(
              ts$5,
            ...
            let ts$6 = ts;
            if (
              (isEqual(ts$6, $transfer_syntax.hevc_h265_main_profile)) || (isEqual(
                ts$6,
              ...
              let ts$7 = ts;
              if (
                ((isEqual(ts$7, $transfer_syntax.jpeg_xl_lossless)) || (isEqual(
                  ts$7,
